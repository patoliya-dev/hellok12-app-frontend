...
const LessonsList = () => {
  ...
  const [breadCrumbData, setBreadCrumbData] = useState([
    { label: "Manage Courses", path: "/school/manage-courses" },
  ...
  const handleCreateLesson = () => navigate(`/school/create-lesson/${courseId}`);
  const handleEditLesson = () => navigate(`/school/edit-lesson/${courseId}`);
