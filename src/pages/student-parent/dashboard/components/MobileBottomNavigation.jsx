...
const MobileBottomNavigation = () => {
  ...
  const navigationItems = [
    {
      ...
      label: "Home",
      icon: "Home",
      path: getRolePath(role, "dashboard"),
      badge: null,
    },
    {
      id: "bookings",
    ...
    },
    {
      ...
      label: "Progress",
      icon: "TrendingUp",
      path: getRolePath(role, "progress"),
      badge: null,
    },
    {
      id: "messages",
      label: "Messages",
      icon: "MessageCircle",
      path: getRolePath(role, "messages"),
      badge: "3",
    },
  ];
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-[60] lg:hidden">
          ...
          >
            ...
            >
              <Icon
                ...
                size={20}
                color={
                  isActive(item.path) ? "var(--color-primary)" : "currentColor"
                }
              />
            </div>
