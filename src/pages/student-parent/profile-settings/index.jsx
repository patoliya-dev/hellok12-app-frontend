        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center space-x-3 text-sm">
              <span className="px-3 py-1 bg-primary/10 text-primary font-medium rounded-full">
                {authUser?.role.charAt(0).toUpperCase() + authUser?.role.slice(1)} Account
              </span>
              <span className="text-text-secondary">• Language: {currentLanguage.toUpperCase()}</span>
            </div>
          </div>
          ...
          <div className="mt-10 pt-6 border-t border-border">
            <div className="flex items-center justify-between">
              ...
              <button className="text-sm font-medium text-error hover:text-error/80 transition-colors">Delete Account</button>
            </div>
          </div>
        </div>
      </main>
