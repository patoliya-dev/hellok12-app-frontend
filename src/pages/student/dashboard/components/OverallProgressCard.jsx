...
const GamificationElements = () => {
  ...
  const getChallengeProgress = () => {
    ...
    return (
      (gamificationData.weeklyChallenge.progress /
        gamificationData.weeklyChallenge.total) *
      100
    );
  };
        ...
        <div className="mb-4">
          <div className="flex justify-between text-sm mb-2">
            <span className="text-muted-foreground">
              Progress to Level {gamificationData.currentLevel + 1}
            </span>
            <span className="text-foreground">
              {gamificationData.xpToNextLevel} XP to go
            </span>
          </div>
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="text-center">
            ...
            <div className="text-lg font-bold text-foreground">
              {gamificationData.learningStreak}
            </div>
          ...
          <div className="text-center">
            ...
            <div className="text-lg font-bold text-foreground">
              {gamificationData.gemsCollected}
            </div>
          ...
          <div className="text-center">
            ...
            <div className="text-lg font-bold text-foreground">
              #{gamificationData.leaderboard?.position}
            </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center p-3 bg-muted/50 rounded-lg">
            ...
            <div className="text-lg font-bold text-warning">
              {gamificationData.powerUps?.doubleXP}
            </div>
          </div>
          ...
          <div className="text-center p-3 bg-muted/50 rounded-lg">
            ...
            <div className="text-lg font-bold text-primary">
              {gamificationData.powerUps?.streakFreeze}
            </div>
          </div>
          ...
          <div className="text-center p-3 bg-muted/50 rounded-lg">
            ...
            <div className="text-xs text-muted-foreground mb-2">
              Extra hints in games
            </div>
            <div className="text-lg font-bold text-success">
              {gamificationData.powerUps?.hintBonus}
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-3">
          {recentActivities.map((activity) => (
            ...
            >
              <div className="flex items-center space-x-3">
                <div
                  className={`w-8 h-8 rounded-full bg-white flex items-center justify-center ${activity.color}`}
                >
