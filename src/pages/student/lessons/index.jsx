        ...
        <div className="p-4 md:p-8 max-w-[1400px] mx-auto">
          <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-brand-gray-600 mt-1">Your learning upcoming lessons and booking history</p>
            </div>
          ...
          <div className="flex">
            <div className='bg-brand-gray-200 p-1.5 flex items-center gap-4 rounded-lg flex items-center gap-2 sm mb-6'>
              {/* <div className='flex justify-center align-items-center items-center'> */}
              <button className={getTabClass('upcoming')} onClick={() => setActiveTab('upcoming')}>
          ...
          <main>
            {activeTab === 'upcoming' ? <UpcomingLessons /> : <LessonsHistory />}
          </main>
        </div>
      </main>
    </div>
