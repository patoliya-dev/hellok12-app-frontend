...
import { fetchCourses, fetchCourse, createCourse, updateCourse, removeCourse, duplicateCourse } from './courseThunks';
...
export const courseDetailSlice = createSlice({
  ...
  reducers: { resetCourseDetail(s){ Object.assign(s, detailInit); } },
  extraReducers: (b)=>{
...
export const { setCourseFilters, resetCourseList } = courseListSlice.actions;
