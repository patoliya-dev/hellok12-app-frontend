...
const profileSlice = createSlice({
  ...
  initialState,
  reducers: {
    updateParent(state, action) { state.parent = { ...state.parent, ...action.payload }; },
    updateStudent(state, action) {
      const { id, data } = action.payload;
      state.students = state.students.map(student => student.id === id ? { ...student, ...data } : student);
    },
...
export const { updateParent, updateStudent, addStudent, deleteStudent, selectStudent } = profileSlice.actions;
